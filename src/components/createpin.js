    ...
    const handleOnSubmit = async (e) => {
      ...
      inputValues.map(async(value, index) =>{
        ...
        const MyDropzone = ({index, pictures}) => {
          ...
          return (
            <div className="pic">
              <button className="button-newpost" onClick={addNewpin}>New Pin</button>
            <h2>Add Image:</h2>

            <div {...getRootProps({id: `my-dropzone-${index}`})}
            ...
            <div className="div-createpost">
              <button className="button-createpost" onClick={handleOnSubmit}>Create post</button>
            </div>
